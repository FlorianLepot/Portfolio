...
use FL\BlogBundle\Form\PostType;
...
class AdminPostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FLBlogBundle:Post')->findAll();
     ...
     *
     * @Route("/", name="admin_posts_create")
     * @Method("POST")
     * @Template("FLBlogBundle:AdminPost:new.html.twig")
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new PostType(), $entity, array(
            'action' => $this->generateUrl('admin_posts_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_posts_update")
     * @Method("PUT")
     * @Template("FLBlogBundle:AdminPost:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_posts_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_posts_delete', array('id' => $id)))
            ->setMethod('DELETE')
